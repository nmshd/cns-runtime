...
export const CreateRelationshipInfoRequest = {
    ...
    definitions: {
        CreateRelationshipInfoRequest: {
            ...
            required: ["relationshipId", "attributes", "isPinned", "title"],
            additionalProperties: false
        },
        RelationshipAttributeDTO: {
            ...
            required: ["name", "content", "sharedItem"],
            additionalProperties: false
        },
        AttributeJSON: {
            type: "object",
        ...
        RelationshipThemeDTO: {
            ...
            required: ["image", "imageBar", "backgroundColor", "foregroundColor"],
            additionalProperties: false
        }
    }
};
...
export const UpdateRelationshipInfoRequest = {
    ...
    definitions: {
        UpdateRelationshipInfoRequest: {
            ...
            additionalProperties: false,
            description:
                "Overwrite a RelationshipInfo's attributes with the request's corresponding fields. Undefined fields in the request will leave the corresponding RelationshipInfo's attributes untouched."
        },
        RelationshipAttributeDTO: {
            type: "object",
            properties: {
...
export const CreateSharedItemRequest = {
    ...
    definitions: {
        CreateSharedItemRequest: {
            ...
            required: ["sharedBy", "sharedWith", "sharedAt", "content"],
            additionalProperties: false
        }
    }
};
