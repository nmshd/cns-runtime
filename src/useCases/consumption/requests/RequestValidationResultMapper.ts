import { ErrorValidationResult, ValidationResult } from "@nmshd/consumption";
...
export class RequestValidationResultMapper {
    public static toRequestValidationResultDTO(request: ValidationResult): RequestValidationResultDTO {
        return {
            ...
            code: request.isError() ? (request as ErrorValidationResult).error.code : undefined,
            message: request.isError() ? (request as ErrorValidationResult).error.message : undefined,
